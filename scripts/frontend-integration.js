 ...
 * This file demonstrates how to integrate Zennook with a web frontend
 */

// For React/Vue/Angular applications
export class ZennookClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new ZennookClient(provider, contractAddress);
